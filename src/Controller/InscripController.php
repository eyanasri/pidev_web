...
class InscripController extends AbstractController
{
    ...
    /**
     * @Route("/inscripAdmin", name="inscrip_admin", methods={"GET"})
     */
    public function indexx(InscripRepository $inscripRepository): Response
    {
        return $this->render('inscrip/affichadmin.html.twig', [
            'inscrips' => $inscripRepository->findAll(),
        ]);
    }
...
///////////////////////////
    ...
    /**
     * @Route("/{id}/admin", name="inscripadmin_show", methods={"GET"})
     */
    public function showw(Inscrip $inscrip): Response
    {
        return $this->render('inscrip/showadmin.html.twig', [
            'inscrip' => $inscrip,
        ]);
    }
    ...
    /**
     * @Route("/{id}/edit/admin", name="inscripadmin_edit", methods={"GET","POST"})
     */
    public function editt(Request $request, Inscrip $inscrip): Response
    {
        $form = $this->createForm(InscripType::class, $inscrip);
        $form->handleRequest($request);
        ...
        return $this->render('inscrip/editadmin.html.twig', [
            'inscrip' => $inscrip,
            'form' => $form->createView(),
        ]);
    }
