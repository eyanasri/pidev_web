...
class OffreController extends AbstractController
{
     ...
     */
    public function new(Request $request , \Swift_Mailer $mailer, ProviderManager $providerManager): Response
    {
        $offre = new Offre();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->persist($offre);
                ...
                $sms = new Sms('54137262', 'The cake is a lie');
                $provider = $providerManager->getProvider('Jobcore');

                $provider->send($sms);

            $message = (new \Swift_Message('email offre d emploi '))
                ->setFrom('jobcore.esprit123@gmail.com')
