...
class UsersAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function checkCredentials($credentials, UserInterface $user)
    {
        if($user->getBlocked()==true){
            throw new CustomUserMessageAuthenticationException('votre compte est bloqué temporairement vous n 
            avez pas le droit de vous connecter');
        }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('users_profile'));
    }
